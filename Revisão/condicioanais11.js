// A) Criando a variável genero e atribuindo um valor
let genero = "ação"; // Pode ser "ação", "comédia", "terror", "ficção" ou "aventura"

// B) Usando condicionais if, else if e else para determinar o gosto do aluno
if (genero === "ação") {
